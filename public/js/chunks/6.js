...
var _Page = __webpack_require__(492);
...
var _service = __webpack_require__(493);
...
var Page = function (_Component) {
  ...
  _createClass(Page, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (!_lodash2.default.isEqual(this.state.user, user)) {
    ...
    value: function handleChange(name, value) {
      ...
      this.setState({ user: _extends({}, this.props.user, _defineProperty({}, name, value)) });
    ...
    value: function submit(user) {
      ...
      this.props.dispatch((0, _service.userUpdateRequest)(user)).catch(function (_ref) {
...
function userUpdateRequest(params) {
  return function (dispatch) {
    return new Promise(function (resolve, reject) {
      _Http2.default.patch('/users/' + params.id, _Transformer2.default.send(params)).then(function (res) {
        dispatch(userActions.userUpdate(_Transformer2.default.fetch(res.data.user)));
        return resolve();
      }).catch(function (err) {
...
var Form = function Form(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        'label',
        { htmlFor: 'phone', className: 'col-sm-2 col-form-label' },
        'Phone'
      ),
      _react2.default.createElement(
        'div',
        ...
        errors.has('phone') && _react2.default.createElement(
          'div',
          { className: 'invalid-feedback' },
          errors.first('phone')
        )
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        'label',
        { htmlFor: 'about', className: 'col-sm-2 col-form-label' },
        'About'
      ),
      _react2.default.createElement(
        'div',
        { className: 'col-sm-10' },
        _react2.default.createElement('textarea', { id: 'about',
          name: 'about',
        ...
        errors.has('about') && _react2.default.createElement(
          'div',
          { className: 'invalid-feedback' },
          errors.first('about')
        )
